...
// */
////实现了SqlSession和SqlSessionFactory接口 维护了两个重要的私有字段 SQLSessionFactory 和 代理增强过SqlSessionProxy
//public class SqlSessionManager implements SqlSessionFactory, SqlSession {
//
//  private final SqlSessionFactory sqlSessionFactory; //DefaultSqlSessionFactory实例
//  private final SqlSession sqlSessionProxy;          //通过JDK动态代理产生的SqlSession实例，是为了通过拦截器InvocationHandler 将target增强，target就是DefaultSqlSession
//
//  //存储SqlSession线程局部变量的地方
//  private ThreadLocal<SqlSession> localSqlSession = new ThreadLocal<SqlSession>();
//
//  //私有的构造方法，传入SqlSessionFactory

...
import java.util.Formatter;package java.lang;
...
/**
 * String 是一个不可继承的类 由final关键词修饰，实现了Serializabe（序列化） Comparable（比较） CharSequence接口
 * 底层实现还是依赖于char[] 字符数组
 */
public final class String
    ...
    public String(char value[]) {
        this.value = Arrays.copyOf(value, value.length); //调用Arrays工具类 拷贝char数组
    }
